...
export default function AdminIGDPage() {
  ...
  return (
<div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-amber-500 selection:text-white relative overflow-hidden print:min-h-0 print:block print:bg-white print:justify-start">      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-amber-200/40 rounded-full blur-[140px] pointer-events-none -z-10"></div>
