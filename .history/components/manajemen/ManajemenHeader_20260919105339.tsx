...
import { Building2, ArrowLeft, ShieldAlert, Maximize2, Minimize2, LayoutDashboard, ChevronDown, Search, CalendarClock } from 'lucide-react';
...
export default function ManajemenHeader({
  ...
  // TAMBAHAN: State untuk jam live real-time di header
    ...
    <header className="w-full bg-white/90 border-b border-slate-200/80 backdrop-blur-xl sticky top-0 z-40 shadow-sm transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* TAMBAHAN: Widget Jam Live di Header */}
