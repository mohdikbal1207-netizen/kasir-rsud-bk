...
import { ShieldCheck, Server, Lock, HeartHandshake, Code2, Cpu, Activity, Mail, CheckCircle2, Clock, Headphones, Printer, Info, Globe2 } from 'lucide-react';
...
export default function ManajemenFooter() {
  ...
  // TAMBAHAN: State untuk mode tampilan footer (Light / Dark Mode toggle khusus footer)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-6">
        ...
        <div className={`flex flex-col sm:flex-row items-center justify-between gap-4 text-xs ${isFooterDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
          <p className="font-medium text-center sm:text-left">
            &copy; {new Date().getFullYear()} <strong className={isFooterDarkMode ? 'text-white' : 'text-slate-700'}>RSUD Bukit Kerman</strong> — Kabupaten Kerinci. Hak Cipta Dilindungi Undang-Undang.
          </p>
          <div className="flex items-center space-x-3 sm:space-x-4 font-semibold text-[11px] flex-wrap justify-center sm:justify-end">
            ...
            {/* TAMBAHAN: Tombol Toggle Mode Gelap / Terang Khusus Footer */}
            <button 
