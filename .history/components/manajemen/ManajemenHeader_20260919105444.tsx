...
import { ArrowLeft, ShieldAlert, Maximize2, Minimize2, LayoutDashboard, ChevronDown, CalendarClock } from 'lucide-react';
    ...
    <header className="w-full bg-white/90 border-b border-slate-200/80 backdrop-blur-xl sticky top-0 z-40 shadow-sm transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* TAMBAHAN: Logo Resmi RSUD Bukit Kerman & Logo Kabupaten Kerinci */}
          <div className="flex items-center space-x-2">
            <div className="w-11 h-11 rounded-2xl bg-white border border-slate-200 p-1 flex items-center justify-center shadow-sm overflow-hidden shrink-0">
              <img 
                src="/logo-rsud.jpeg" 
            ...
            <div className="w-11 h-11 rounded-2xl bg-sky-50 border border-sky-200 p-1 flex items-center justify-center shadow-sm overflow-hidden shrink-0 hidden sm:flex">
              <img 
        ...
        {/* Bagian Kanan: Jam Real-Time, Status BLUD, Quick Actions & Fullscreen Toggle */}
        <div className="flex items-center space-x-3">
          
          {/* Widget Jam Live di Header */}
          <div className="hidden xl:flex items-center space-x-2 bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-2xl text-xs font-mono font-bold text-slate-600">
