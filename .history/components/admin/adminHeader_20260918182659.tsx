...
import { ArrowLeft, ShieldCheck, Clock, UserCheck, Activity, Calendar, Bell } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-3.5">
          ...
          <div>
            <div className="flex items-center space-x-2 flex-wrap gap-y-1">
              ...
              <span className="bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase">
                {badgeText}
              </span>
            </div>
        ...
        <div className="hidden xl:flex items-center space-x-3 bg-slate-800/70 border border-slate-700/60 px-4 py-2 rounded-2xl text-xs shadow-inner">
          ...
          <div className="flex items-center space-x-1.5 text-emerald-400">
            ...
            <span className="font-extrabold text-[11px] uppercase tracking-wider">Sistem Aktif</span>
          </div>
