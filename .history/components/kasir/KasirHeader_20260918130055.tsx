...
import { 
  ...
  Building2, Shield, BadgeCheck, Calculator, Bell, CheckCircle2 
} from 'lucide-react';
...
export default function KasirHeader({
  ...
  // FITUR BARU: State untuk Kalkulator Cepat & Notifikasi Antrean
    ...
    <header className="w-full bg-white/85 border-b border-slate-200/80 backdrop-blur-xl sticky top-0 z-40 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col lg:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center flex-wrap gap-2 sm:gap-3 justify-end w-full lg:w-auto">
          ...
          {/* FITUR BARU: Kalkulator Cepat Kembalian Dropdown */}
          ...
          {/* FITUR BARU: Notifikasi Antrean Billing */}
          <div className="relative" ref={notifRef}>
            <button
              ...
              title="Notifikasi Antrean Billing"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-slate-200 p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="flex items-center justify-between pb-2 mb-3 border-b border-slate-100">
                  <span className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                    <Bell className="w-3.5 h-3.5 text-emerald-600" /> Status Antrean Kasir
                  </span>
                ...
                <div className="space-y-2 text-xs">
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 flex items-start space-x-2">
                    ...
                    <div>
                      <p className="font-bold text-slate-800">Sistem Billing Sinkron</p>
                      <p className="text-[11px] text-slate-500">Semua data transaksi poliklinik terhubung ke SIMRS.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Badge Profil Interaktif dengan Dropdown Menu */}
          {currentUserName && (
