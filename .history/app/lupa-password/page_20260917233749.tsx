            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] text-slate-400 pl-1">
                    Contoh: 198501... atau nama.pegawai@rsudbukitkerman.id
                  </p>
                </div>
              ...
              <div className="space-y-4 text-center animate-in fade-in">
                ...
                <div className="space-y-2">
                  ...
                  {/* Tombol Tambahan: Coba Akun Lain / Kirim Ulang */}
                  <button
                    type="button"
                    onClick={() => {
                    ...
                    className="w-full bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-700 font-bold text-xs py-2.5 rounded-2xl transition flex items-center justify-center space-x-1.5 cursor-pointer"
                  >
                    <RotateCcw className="w-3.5 h-3.5 text-slate-500" />
                    <span>Kirim Permintaan untuk Akun Lain</span>
                  </button>
                </div>
              </div>
            )}
