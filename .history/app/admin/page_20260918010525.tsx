...
export default function AdminDashboardPage() {
  ...
  // 3. Catat / Perbarui sesi aktif Admin secara otomatis saat halaman dimuat (Aman dari RLS & Unique Constraint)
  useEffect(() => {
    async function recordAdminSession() {
      try {
        ...
        // Cek apakah sesi untuk user_id ini sudah ada di tabel user_sessions
