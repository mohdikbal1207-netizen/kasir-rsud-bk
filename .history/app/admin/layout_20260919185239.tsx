...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Fitur Baru: Audio Alert System via Web Audio API (Tanpa butuh file MP3 eksternal)
  const playAlertSound = useCallback((type: 'lock' | 'warning' | 'success') => {
    try {
      ...
      // Abaikan jika browser memblokir autopolicy audio
    }
  }, []);
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-2xl pl-4 pr-10 py-3 text-xs text-white focus:outline-none focus:border-emerald-500 transition placeholder-slate-600"
                  />
