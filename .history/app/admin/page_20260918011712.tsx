...
export default function AdminDashboardPage() {
  ...
  // State jumlah pending per modul kasir untuk badge di grid card admin
  ...
  // 1. Hitung jumlah data yang masih pending verifikasi akun pegawai
  useEffect(() => {
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 flex-1 space-y-8 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* CARD 1: Modul Verifikasi & Manajemen Pegawai */}
            <div 
            ...
            {/* CARD 2: Portal Kasir & Billing Utama */}
            <div 
            ...
            {/* CARD 3: Konfigurasi Sistem */}
            <div className="bg-white/60 border border-slate-200/70 rounded-3xl p-6 shadow-sm flex flex-col justify-between space-y-6 relative overflow-hidden opacity-80">
              <div className="space-y-4">
        ...
        {/* ================= GRID CARD PER MODUL KASIR (VERIFIKASI & KONTROL ADMIN) ================= */}
        <div className="space-y-4">
          <div className="flex items-center justify-between px-1">
            <h2 className="text-sm font-bold text-slate-700 uppercase tracking-wider">
              Kontrol Verifikasi Per Modul Kasir
            </h2>
            <span className="text-xs text-slate-400">Akses langsung ke manajemen billing spesifik unit</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            {/* CARD MODUL 1: RAWAT JALAN */}
            <div 
              onClick={() => router.push('/kasir/rawat-jalan')}
              className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-lg shadow-slate-200/50 flex flex-col justify-between space-y-6 transition hover:shadow-xl hover:border-emerald-400 cursor-pointer group relative overflow-hidden"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="w-12 h-12 bg-emerald-50 border border-emerald-200 rounded-2xl text-emerald-600 flex items-center justify-center shadow-sm group-hover:scale-105 transition">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Kelola dan verifikasi pembayaran tagihan poliklinik, resep obat, serta tindakan medis rawat jalan.
                  </p>
                </div>
              </div>

              <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-emerald-600 group-hover:translate-x-1 transition-transform">
                <span>Kelola Rawat Jalan</span>
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>

            {/* CARD MODUL 2: RAWAT INAP */}
            <div 
              onClick={() => router.push('/kasir/rawat-inap')}
              className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-lg shadow-slate-200/50 flex flex-col justify-between space-y-6 transition hover:shadow-xl hover:border-teal-400 cursor-pointer group relative overflow-hidden"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="w-12 h-12 bg-teal-50 border border-teal-200 rounded-2xl text-teal-600 flex items-center justify-center shadow-sm group-hover:scale-105 transition">
                ...
                <div className="space-y-1">
                  <h3 className="text-base font-bold text-slate-900 group-hover:text-teal-700 transition">
                    Verifikasi Rawat Inap
                  </h3>
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Validasi tarif kamar akomodasi inap, visite dokter, tindakan bedah, dan farmasi rawat inap.
                  </p>
                </div>
              </div>

              <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-teal-600 group-hover:translate-x-1 transition-transform">
                <span>Kelola Rawat Inap</span>
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
            ...
            <div 
              ...
              className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-lg shadow-slate-200/50 flex flex-col justify-between space-y-6 transition hover:shadow-xl hover:border-amber-400 cursor-pointer group relative overflow-hidden"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Audit dan verifikasi penanganan gawat darurat, observasi medis, serta tindakan darurat pasien IGD.
                  </p>
                </div>
              </div>
        ...
        {/* MODUL: Monitoring Sesi Aktif & Kontrol Akses Pengguna Masuk */}
