...
import { 
  ...
  Download, CheckSquare2, Square, Layers, Banknote, ArrowUpDown, Filter, BarChart3
} from 'lucide-react';
...
export default function AdminRanapPage() {
  ...
  // Filter & Sorting Logic (Disempurnakan dengan Rentang Tanggal & Penjaminan)
  const filteredPatients = patientList.filter(p => {
    ...
    return matchesSearch && matchesFilter && matchesPenjaminan && matchesDate;
  }).sort((a, b) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 font-sans print:bg-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8 space-y-6 print:p-0 print:m-0 print:max-w-none">
        ...
        {/* Search, Date Range, Penjaminan & Sorting Toolbar (Penyempurnaan Fitur Baru) */}
