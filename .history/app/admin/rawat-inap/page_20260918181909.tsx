...
export default function AdminRanapPage() {
  ...
  // State Pagination (Penyempurnaan Baru)
  ...
  // Listener tombol ESC untuk menutup modal dengan cepat
  useEffect(() => {
  ...
  // Pagination Logic (Penyempurnaan Baru)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 font-sans print:bg-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8 space-y-6 print:p-0 print:m-0 print:max-w-none">
        ...
        {/* Progress Bar & Financial Summary Cards (Interaktif Filter) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 print:hidden">
          {/* Kartu Statistik 1: Klik untuk set filter status ALL / reset */}
          <div 
          ...
          {/* Kartu Statistik 2: Klik untuk filter penjaminan BPJS */}
          <div 
          ...
          {/* Kartu Statistik 3: Klik untuk filter penjaminan Umum */}
          <div 
        ...
        {/* Search, Date Range, Room Filter & Sorting Toolbar */}
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden print:hidden flex flex-col">
          ...
          {/* Pagination Footer Controls (Penyempurnaan Baru) */}
