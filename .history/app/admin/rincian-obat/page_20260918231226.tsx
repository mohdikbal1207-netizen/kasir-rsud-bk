...
export default function AdminRincianObatPage() {
  ...
  const handleCopyNoTransaksi = (noTransaksi: string) => {
    ...
    showToast(`No. Transaksi ${noTransaksi} berhasil disalin!`);
  };
  ...
  // Fitur Tambahan: Ekspor CSV Hanya untuk Baris Terpilih
  const handleExportSelectedCSV = () => {
    ...
    link.click();
    document.body.removeChild(link);
    showToast(`Berhasil mengunduh ${selectedRecords.length} data terpilih.`);
  };
