...
export default function AdminKwitansiPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-purple-500 selection:text-white">
      ...
      {/* MODAL ANALISIS KEUANGAN PER KODE AKUN */}
      {showAnalyticsModal && (
        <div className="fixed inset-0 z-70 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-5 animate-in fade-in">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-2xl p-4 text-xs text-purple-900 space-y-1">
              <p className="font-bold flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-purple-600" /> Ringkasan Audit Pengawasan BLUD</p>
              <p className="text-purple-700 leading-relaxed">Nilai di atas dihitung secara otomatis dari seluruh kwitansi yang berstatus <strong className="uppercase">Disetujui</strong> oleh Super Admin.</p>
            </div>
