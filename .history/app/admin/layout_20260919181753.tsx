...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // TAMBAHAN: State untuk Toast Notification Keamanan Interaktif
  ...
  // TAMBAHAN: Tab Visibility Watcher - Re-verify sesi saat admin kembali ke tab
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* TAMBAHAN: Toast Notifikasi Keamanan Melayang */}
      {toastMessage && (
