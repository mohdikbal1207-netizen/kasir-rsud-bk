...
export default function AdminDashboardPage() {
  ...
  // FITUR BARU: State untuk Status Realtime Maintenance Mode
  const [isMaintenanceActive, setIsMaintenanceActive] = useState<boolean>(false);

  // Fitur Baru: State Pencarian & Modal Konfirmasi
  ...
  const fetchCounts = async () => {
    try {
      ...
      // FITUR BARU: Ambil Status Realtime Maintenance Mode
  ...
  useEffect(() => {
    ...
    // Fitur Baru: Auto-refresh data sesi aktif tiap 30 detik
  ...
  // Fitur Baru: Filter Pencarian Sesi Aktif Staf
  ...
  // Fitur Baru: Akumulasi Total Seluruh Pending Task
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 flex-1 space-y-8 relative z-10">
        ...
        {/* FITUR BARU: Ringkasan Eksekutif Metrics Bar */}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {/* 9. FITUR BARU: Modul Kontrol Maintenance Mode */}
            <div 
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Atur status perbaikan sistem, pesan pengumuman, dan daftar email yang dikecualikan.
                  </p>
                </div>
              </div>
      ...
      {/* FITUR BARU: Modal Konfirmasi Force Logout Kustom */}
      {targetLogoutUser && (
