...
export default function AdminDashboardPage() {
  ...
  // Hitung jumlah data yang masih pending verifikasi untuk badge notifikasi
  useEffect(() => {
        ...
        <div className="bg-white/90 border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 backdrop-blur-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-500 max-w-xl leading-relaxed">
              Kelola seluruh kontrol sistem informasi, validasi akun pegawai baru, dan pengaturan modul layanan kesehatan RSUD Bukit Kerman secara terpusat.
            </p>
          </div>
