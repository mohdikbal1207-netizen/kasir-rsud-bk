...
export default function AdminRawatJalanVerification() {
  ...
  const [activeTab, setActiveTab] = useState<'pending' | 'lunas' | 'pasien' | 'semua'>('pending');
  ...
  const totalNominal = filteredTransactions.reduce((acc, curr) => acc + Number(curr.total_biaya || 0), 0);
