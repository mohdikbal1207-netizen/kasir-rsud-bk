...
export default function AdminRawatJalanVerification() {
  ...
  // State Identitas Petugas Penginput / Penanggung Jawab
  const [petugasNama, setPetugasNama] = useState<string>('Memuat Petugas...');
  const [petugasNip, setPetugasNip] = useState<string>('-');
  ...
  // FETCH IDENTITAS PETUGAS DARI TABEL USERS & PROFILES SUPABASE
  useEffect(() => {
    const fetchPetugasProfile = async () => {
      try {
        ...
        setPetugasNama(resolvedNama);
        setPetugasNip(resolvedNip);
      } catch (err) {
    ...
    try {
      const { error } = await supabase
        ...
        .update({ 
          ...
          petugas_input_nama: tx.petugas_input_nama || petugasNama,
          petugas_input_nip: tx.petugas_input_nip || petugasNip
        })
        .eq('id', tx.id);
  ...
  const handleExportCSV = () => {
    ...
    const headers = ['ID Transaksi', 'No RM', 'Nama Pasien', 'NIK', 'Poli Tujuan', 'Penjaminan', 'Metode Bayar', 'Petugas Input', 'NIP Petugas', 'Tanggal', 'Total Biaya (Rp)', 'Status', 'Catatan Admin'];
  ...
  const filteredTransactions = transactions.filter(t => {
    const matchSearch = t.nama_pasien?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      ...
      t.petugas_input_nama?.toLowerCase().includes(searchTerm.toLowerCase());
          ...
          <div className="md:col-span-2 bg-white border border-slate-200 rounded-2xl p-3 shadow-sm flex items-center justify-between">
            <div className="flex items-center space-x-3 w-full">
              ...
              <input 
                ref={searchInputRef}
                type="text" 
                placeholder={activeTab === 'pasien' ? "Cari No. RM, Nama Pasien, NIK..." : "Cari Nama, No. RM, ID Transaksi, Petugas..."}
                value={searchTerm}
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-emerald-700 font-semibold mt-1">Petugas: {tx.petugas_input_nama || petugasNama}</p>
                      </div>
                      ...
                      return (
                        <tr key={tx.id} className={`hover:bg-slate-50 transition ${isSelected ? 'bg-teal-50/20' : ''}`}>
                          ...
                          <td className="p-4 font-bold text-slate-800">
                            {tx.petugas_input_nama || petugasNama}
                          </td>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 shadow-2xl space-y-6">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 text-xs space-y-2">
              <div className="grid grid-cols-2 gap-2 font-medium">
                ...
                <p><span className="text-slate-400">Petugas Input:</span> <strong className="text-slate-900">{selectedDetail.petugas_input_nama || petugasNama}</strong></p>
              </div>
          ...
          <div className="p-8 max-w-4xl mx-auto space-y-4">
            ...
            <table className="w-full border-collapse border border-black text-[10pt]">
              <thead>
                <tr className="bg-slate-100 font-bold">
                  ...
                  <th className="border border-black p-1.5">PETUGAS KASIR</th>
              ...
              <tbody>
                {filteredTransactions.map((tx, idx) => (
                  <tr key={tx.id}>
                    ...
                    <td className="border border-black p-1">{tx.petugas_input_nama || petugasNama}</td>
                ...
                <tr className="font-bold bg-slate-100">
                  <td colSpan={6} className="border border-black p-2 text-right uppercase">AKUMULASI TOTAL PENDAPATAN:</td>
            ...
            <div className="grid grid-cols-2 text-center text-xs pt-12">
              ...
              <div className="space-y-16">
                ...
                <p className="font-bold pt-8">( {petugasNama} )</p>
              </div>
            </div>
          </div>
        ) : selectedDetail ? (() => {
            ...
            <div className="p-8 max-w-3xl mx-auto space-y-4">
              ...
              <div className="grid grid-cols-2 text-center text-xs pt-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="font-bold">( {selectedDetail.petugas_input_nama || petugasNama} )</p>
                </div>
              </div>
            </div>
          );
