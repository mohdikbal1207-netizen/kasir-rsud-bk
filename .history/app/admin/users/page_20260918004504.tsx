...
export default function AdminVerificationPage() {
  ...
  // State untuk Modal Interaktif (Approve / Reset / Preview Foto)
  const [modalMode, setModalMode] = useState<'approve' | 'reset' | 'preview' | null>(null);
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden">
        ...
        <div className="bg-white/90 border border-slate-200/80 rounded-3xl p-6 shadow-xl shadow-slate-200/50 backdrop-blur-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-slate-500">
              Tinjau dokumen, tentukan hak akses role (Kasir / Manajemen), dan aktifkan akun staf baru secara aman.
            </p>
          </div>
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3.5">
                      {/* Avatar / Foto Profil dengan tombol klik pratinjau */}
                      <div 
                  ...
                  {/* --- COMMAND BAR AKSI (SMART & PROFESSIONAL) --- */}
                  <div className="pt-3 border-t border-slate-100 flex items-center gap-2">
                    ...
                    {/* Tombol Sekunder: Atur Ulang Sandi */}
                    <button
      ...
      {/* --- MODAL INTERAKTIF: PRATINJAU FOTO PEGAWAI (ZOOM) --- */}
