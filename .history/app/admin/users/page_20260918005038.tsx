                    ...
                    {activeTab === 'rejected' && (
                      <>
                        <button
                          ...
                          disabled={isActionProcessing}
                          className="flex-1 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-700 font-bold text-xs py-2.5 px-3 rounded-2xl transition flex items-center justify-center space-x-1.5 cursor-pointer disabled:opacity-50 active:scale-95 shadow-sm"
                          title="Pulihkan Akun kembali ke Pending"
                        >
                        ...
                        <button
                          ...
                          disabled={isActionProcessing}
                          className="bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 p-2.5 rounded-2xl transition flex items-center justify-center cursor-pointer disabled:opacity-50 active:scale-95 shadow-sm"
