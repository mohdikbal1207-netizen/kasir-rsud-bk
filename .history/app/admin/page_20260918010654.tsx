...
export default function AdminDashboardPage() {
  ...
  // 3. Catat / Perbarui sesi aktif Admin secara otomatis (Menggunakan .limit(1) aman dari duplikasi baris)
  useEffect(() => {
    async function recordAdminSession() {
      try {
        ...
        // Cek sesi menggunakan .limit(1) agar aman meskipun ada banyak baris duplikat
