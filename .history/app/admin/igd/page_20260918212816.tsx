...
export default function AdminIGDPage() {
  ...
  // States for selection, detail, receipt, & analytics modals
  ...
  const handleExportCSV = () => {
    ...
    setMessage({ type: 'success', text: `Berhasil mengunduh ${filtered.length} data laporan kasir IGD dalam format CSV.` });
  };
