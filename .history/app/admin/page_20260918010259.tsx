...
export default function AdminDashboardPage() {
  ...
  // 3. Catat / Perbarui sesi aktif Admin secara otomatis saat halaman dimuat
  useEffect(() => {
    async function recordAdminSession() {
      try {
        ...
        // Simpan sesi ke tabel user_sessions (pastikan kolom user_id diset Unique di Supabase)
        await supabase.from('user_sessions').upsert({
          user_id: userId,
          nama_lengkap: profile?.nama_lengkap || 'Administrator Pusat',
