...
export default function AdminDashboardPage() {
  ...
  // 3. Catat / Perbarui sesi aktif Admin secara otomatis (Dilengkapi Upsert Aman)
  useEffect(() => {
    async function recordAdminSession() {
      try {
        ...
        // Cek apakah sudah ada baris sesi untuk user_id ini
        ...
        if (existingSessions && existingSessions.length > 0) {
          // Perbarui sesi yang sudah ada agar is_active menjadi true
          await supabase
            .from('user_sessions')
            .update({
          ...
          // Masukkan data baru jika belum ada sama sekali
          await supabase
            .from('user_sessions')
            .insert({
              user_id: userId,
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 flex-1 space-y-8 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {/* 10. FITUR BARU: Modul Pusat Keamanan IP & Anti Brute-Force */}
            <div 
