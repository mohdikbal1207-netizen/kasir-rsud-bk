...
import { 
  ...
  History, CheckCircle2, Clock, FileText, Eye, Trash2, AlertCircle, RefreshCw, ArrowLeft, X, FileSpreadsheet, Filter, Calendar 
} from 'lucide-react';
...
export default function FormKasirIGD() {
  ...
  // Sinkronisasi data real-time dengan localStorage
  ...
  // Deteksi otomatis rekam medis pasien sebelumnya
  ...
  // Statistik Keuangan Dinamis Berdasarkan Filter Aktif
        ...
        {activeTab === 'form' && (
          <div className="bg-white text-slate-800 shadow-2xl rounded-3xl p-6 sm:p-10 border border-slate-200 print:shadow-none print:border-none print:p-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-50 p-5 rounded-2xl border border-slate-200 mb-6 print:bg-transparent print:border-none print:p-0">
              ...
              <div>
                <label className="block text-[11px] font-bold uppercase text-slate-600 mb-1">Metode Pembayaran</label>
                <select 
                  name="metodeBayar"
              ...
              <div>
                <label className="block text-[11px] font-bold uppercase text-slate-600 mb-1">Penjaminan Pasien</label>
                <select 
                  name="penjaminan"
