...
import { 
  ...
  History, FileText, Eye, AlertCircle, RefreshCw, ArrowLeft, X, FileSpreadsheet, Calendar, User, Banknote, Zap, CheckCircle2, ShieldCheck, Info, Download, Upload, Plus, Minus
} from 'lucide-react';
            ...
            <tbody className="divide-y divide-black/30">
              {filteredRiwayat.map((item, idx) => (
                <tr key={item.id}>
                  ...
                  <td className="py-1.5 px-2">{item.metodeBayar} ({item.penjaminan})</td>
