...
import { 
  ...
  History, FileText, Eye, AlertCircle, RefreshCw, ArrowLeft, X, FileSpreadsheet, Calendar, User, Banknote, Zap, CheckCircle2, ShieldCheck, Info, Download, Upload, Plus, Minus, Trash2, Copy, Receipt
} from 'lucide-react';
