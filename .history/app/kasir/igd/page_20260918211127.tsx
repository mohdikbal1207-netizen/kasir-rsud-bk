...
import { 
  ...
  History, FileText, Eye, AlertCircle, RefreshCw, ArrowLeft, X, FileSpreadsheet, Calendar, User, Banknote, Zap, CheckCircle2, ShieldCheck, Info, Download, Upload, Plus, Minus, Trash2
} from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 print:hidden">
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl border border-slate-200 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-between items-center">
              <button
                onClick={() => {
                  // Temporary populate form with detail for printing or trigger print
                  setFormData(prev => ({
                    ...prev,
