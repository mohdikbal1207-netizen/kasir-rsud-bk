...
import { 
  ...
  History, CheckCircle2, Clock, FileText, Eye, Trash2, AlertCircle, RefreshCw 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 font-sans">
      ...
      <main className="flex-grow max-w-5xl mx-auto px-4 py-6 sm:py-8 w-full">
        ...
        {/* TAB NAVIGASI UTAMA (DILINDUNGI SAAT CETAK) */}
                ...
                <tbody className="divide-y divide-slate-100 print:divide-slate-300">
                  {filteredTindakan.length > 0 ? (
                    filteredTindakan.map((item) => {
                      ...
                      // Saat mencetak, sembunyikan baris tindakan yang qty-nya 0
          ...
          <div className="bg-white text-slate-800 shadow-2xl rounded-3xl p-6 sm:p-10 border border-slate-200 space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                {/* Search Bar Riwayat RM / Nama Pasien */}
                        ...
                        <td className="p-3 text-center">
                          <div className="flex items-center justify-center space-x-1.5">
                            <button 
                              ...
                              title="Buka / Edit Formulir Pasien Ini"
                            >
