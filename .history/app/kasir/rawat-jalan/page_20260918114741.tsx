...
export default function KasirRawatJalanPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden">
      ...
      <KasirHeader title="RSUD BUKIT KERMAN" subtitle="Modul Rincian Biaya Pelayanan Rawat Jalan" />

      <main className="w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 flex-1 space-y-6 relative z-10 pb-24">
        
        {/* Navigasi Tab Form / Riwayat */}
        <div className="flex items-center justify-between bg-white/90 border border-slate-200 p-2 rounded-2xl shadow-sm backdrop-blur-md">
          ...
          <span className="text-xs font-semibold text-slate-500 px-3 hidden sm:inline">Kabupaten Kerinci</span>
        </div>
