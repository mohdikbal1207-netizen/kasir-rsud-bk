...
export default function InputRawatInapPage() {
  ...
  // 1. Memuat Auth & Data Petugas serta Memulihkan Draft localStorage
  useEffect(() => {
    ...
    // Pulihkan Draft LocalStorage jika ada
  ...
  // Simpan Otomatis ke LocalStorage (Auto-Save Draft)
  useEffect(() => {
  ...
  // 2. Kueri Teroptimasi dengan Relasi Join Supabase
  ...
  const handleSubmitToDatabase = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Bersihkan Draft LocalStorage setelah sukses
