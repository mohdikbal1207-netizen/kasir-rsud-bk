...
export default function InputRawatInapPage() {
  ...
  // STATE: POP-UP LIST DISET FALSE AGAR TIDAK MUNCUL OTOMATIS SAAT HALAMAN DIBUKA
  ...
  // PERBAIKAN UTAMA: KARTU RINGKASAN MENGHITUNG OTOMATIS SELURUH `filteredBillings` (TIDAK PERLU DICENTANG DULU)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 font-sans print:bg-white relative">
      ...
      {/* POP-UP 2: DETAIL RIWAYAT PASIEN SPESIFIK */}
