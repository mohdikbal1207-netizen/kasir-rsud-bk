...
import { 
  ...
  ListFilter, Clock, AlertCircle, CheckSquare, Square
} from 'lucide-react';
...
interface BillingItem {
  ...
  volume: number;
  tarif: number;
  isCovered: boolean; // Ceklis Ditanggung BPJS/Penjamin
}
...
export default function InputRawatInapPage() {
  ...
  // Preset Penjaminan & Ceklis Massal Otomatis
  const handleApplyPreset = (type: 'umum' | 'bpjs') => {
    ...
    // Otomatis centang/uncentang semua item berdasarkan jenis penjaminan
                          ...
                          {categoryItems.map((item) => {
                            ...
                            return (
                              <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                                ...
                                {/* INPUT TARIF DENGAN FORMAT TITIK */}
