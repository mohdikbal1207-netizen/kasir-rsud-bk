  ...
  export default function InputRawatInapPage() {
   ...
   // Mengambil data petugas secara dinamis dari akun yang sedang login
  useEffect(() => {
    const fetchCurrentUser = async () => {
      try {
        ...
        if (user) {
          ...
          // Ambil nama dan NIP langsung dari akun yang sedang aktif login
          const petugasNama = 
            meta.nama_lengkap || 
            meta.full_name || 
            meta.name || 
          ...
          const petugasNipVal = meta.nip || '-';

          setPatientData(prev => ({
            ...prev,
            bendahara: petugasNama,
