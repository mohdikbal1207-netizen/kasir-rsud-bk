...
import { 
  ...
  ListFilter, Clock, AlertCircle, ShieldAlert
} from 'lucide-react';
...
export default function InputRawatInapPage() {
  ...
  // Ambil Nama Akun Login Aktif dari Supabase
  useEffect(() => {
  ...
  // Submit Pengajuan ke Supabase (Status: PENDING_VERIFIKASI)
  const handleSubmitToDatabase = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Simpan Header Tagihan dengan status PENDING_VERIFIKASI
