...
import { 
  ArrowLeft, Save, Plus, Trash2, ShieldCheck, Eraser, UserCheck, Calculator, Calendar
} from 'lucide-react';
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 sm:p-8 space-y-6">
          ...
          <div className="flex items-center justify-between pb-6 border-b-2 border-slate-800 gap-4">
            ...
            <div className="flex-shrink-0 w-20 h-24 relative flex items-center justify-center">
              {!logoKerinciErr ? (
                ...
                <div className="w-16 h-16 bg-amber-100 border border-amber-300 text-amber-800 rounded-full flex flex-col items-center justify-center text-[9px] font-bold text-center p-1">
                  <span>PEMKAB</span>
                  <span>KERINCI</span>
                </div>
              )}
            ...
            <div className="flex-shrink-0 w-20 h-24 relative flex items-center justify-center">
              {!logoRsudErr ? (
                ...
                <div className="w-16 h-16 bg-emerald-100 border border-emerald-300 text-emerald-800 rounded-full flex flex-col items-center justify-center text-[9px] font-bold text-center p-1">
                  <span>RSUD</span>
                  <span>KERMAN</span>
                </div>
              )}
          ...
          <form onSubmit={handleSubmitToDatabase} className="space-y-6">
            ...
            {/* Tanggal & Penjaminan */}
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 bg-emerald-50/40 p-4 rounded-2xl border border-emerald-100">
              <div>
