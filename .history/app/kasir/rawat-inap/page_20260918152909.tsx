...
export default function InputRawatInapPage() {
  ...
  // Ambil Nama Lengkap Akun Login dari Supabase Auth secara Otomatis
  useEffect(() => {
  ...
  const handleSubmitToDatabase = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Rincian Biaya Rawat Inap Berhasil Disimpan & Verified!');
      router.push('/kasir');
    } catch (err: any) {
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1 pl-6 border-l-2 border-emerald-500">
                    <p className="text-xs text-slate-500">
                      Nama Lengkap: <span className="font-bold text-slate-900 text-sm">{patientData.bendahara}</span>
                    </p>
