        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-white border border-slate-200/80 p-5 rounded-3xl shadow-sm flex items-center justify-between">
            <div className="space-y-1">
              <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Absensi Anda Hari Ini</span>
              <h3 className="text-xl font-black text-slate-900">{todayRecords.length} Berkas Tercatat</h3>
            </div>
          ...
          <div className="border border-slate-200 rounded-2xl overflow-hidden">
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-slate-100 font-medium">
                {isLoading ? (
                  <tr><td colSpan={5} className="text-center py-10 text-slate-400">Memuat rekap absensi...</td></tr>
                ) : paginatedRecords.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="text-center py-16 text-slate-400 space-y-2">
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl space-y-5 animate-in fade-in max-h-[92vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveAbsensi} className="space-y-4 text-xs">
              ...
              <div className={`p-4 rounded-2xl border text-xs flex items-center justify-between gap-3 ${
                ...
                <button type="button" onClick={checkGPSLocation} className="p-2.5 bg-white hover:bg-slate-100 rounded-xl border border-slate-200 shadow-xs cursor-pointer" title="Perbarui Lokasi GPS">
