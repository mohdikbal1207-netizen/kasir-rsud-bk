...
export default function KasirLayout({ children }: { children: React.ReactNode }) {
  ...
  // Fitur Baru: Pengelola Koneksi & Inaktivitas
  ...
  // Fitur Baru: Pengelola Identitas & Quick Lock Screen
  ...
  // Fitur Baru: Loading State & Durasi Sesi & Latency DB
  ...
  // Fitur Baru: Pengamanan Unlock dengan Proteksi Rate Limiting & Account Lockout Sinkron
