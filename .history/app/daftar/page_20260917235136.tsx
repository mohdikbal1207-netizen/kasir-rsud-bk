...
export default function DaftarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 4. Daftarkan akun ke Supabase Auth (diberi metadata tanpa memicu verifikasi email)
      ...
      // 5. Simpan data kredensial / role ke tabel `users` menggunakan .upsert()
        ...
        .upsert([
          {
            ...
            is_active: false, // Menunggu verifikasi admin manual
          }
        ], { onConflict: 'id' });
      ...
      // 7. Kirim Notifikasi WhatsApp Otomatis ke Admin IT (Mohd. Ikbal - 6282281155614)
