...
export default function DaftarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 4. Daftarkan akun ke Supabase Auth
      ...
      // 5. Simpan data kredensial / role ke tabel `users`
      ...
      // 6. Simpan profil lengkap ke tabel `profiles`
      ...
      // 7. Kirim Notifikasi WhatsApp Otomatis ke Admin IT
