...
export default function DaftarPage() {
  ...
  // Daftar Unit Kerja Standar RSUD Bukit Kerman untuk Rekomendasi Input
  const standardUnits = [
    'Instalasi Gawat Darurat (IGD)',
    'Kasir & Pembayaran Tarif BLUD',
    'Sistem Informasi (SIMRS) & IT',
        ...
        <div className="w-full space-y-4">
          ...
          <div className="bg-white/95 border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 backdrop-blur-xl relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Baris Input 4 (Unit Kerja Datalist & Sandi dengan Show/Hide & Strength Meter) */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-10 pr-10 py-2.5 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 font-medium"
                    />
                    <button
                      type="button"
