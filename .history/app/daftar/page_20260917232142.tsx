...
export default function DaftarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Cek apakah NIK sudah terdaftar sebelumnya di tabel profiles
      ...
      // 1. Unggah Foto ke Supabase Storage jika ada
      if (selectedFile) {
      ...
      // 2. Daftarkan akun ke Supabase Auth terlebih dahulu agar mendapatkan UUID Auth yang valid
      ...
      // 3. Simpan data kredensial / role ke tabel `users` menggunakan ID yang sama
      ...
      // 4. Simpan profil lengkap ke tabel `profiles` menggunakan ID yang sama
      setLoadingStepText('Menyimpan profil pegawai...');
      const formattedPhone = formatPhoneNumber(formData.no_telepon);
      ...
      // 5. Kirim Notifikasi WhatsApp Otomatis ke Admin / IT Coordinator (Mohd. Ikbal - 6282281155614)
      ...
      const adminMessage = 
        ...
        `🏥 *Unit Kerja:* ${formData.unit_kerja}\n` +
        `🆔 *NIP/ID:* ${formData.nip}\n` +
      ...
      <main className="w-full max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-10 flex-1 flex items-center justify-center relative z-10">
        <div className="w-full space-y-4">
          ...
          <div className="bg-white/95 border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="mb-5 p-3.5 bg-sky-50 border border-sky-200 rounded-2xl text-xs text-sky-800 flex items-start space-x-2.5 shadow-sm">
            ...
            {errorMessage && (
              <div className="mb-4 p-3.5 bg-rose-50 border border-rose-200 rounded-2xl text-xs text-rose-700 flex items-start space-x-2.5 shadow-sm" role="alert">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Seksion Unggah Foto (UI/UX Dropzone Enhanced) */}
              <div className="flex flex-col sm:flex-row items-center gap-4 bg-slate-50/90 border border-dashed border-slate-300 p-4 rounded-2xl hover:border-emerald-400 transition-colors">
                <div className="w-20 h-20 rounded-2xl bg-white border border-slate-200 overflow-hidden flex items-center justify-center flex-shrink-0 relative shadow-sm">
                  {previewUrl ? (
                ...
                <div className="space-y-1.5 flex-1 text-center sm:text-left">
                  ...
                  <p className="text-[11px] text-slate-500">Format yang didukung: JPG, JPEG, atau PNG (Ukuran Maksimal 2MB).</p>
                  
                  <label className="inline-flex items-center space-x-1.5 bg-white hover:bg-emerald-50 border border-slate-300 hover:border-emerald-300 text-slate-700 hover:text-emerald-700 text-xs px-3.5 py-2 rounded-xl font-bold cursor-pointer transition shadow-sm">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-10 pr-3.5 py-2.5 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 font-medium transition"
                    />
                  </div>
                </div>
              ...
              {/* Baris Input 4 (Unit Kerja Manual Murni & Sandi dengan Show/Hide & Strength Meter) */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-10 pr-10 py-2.5 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 font-medium transition"
                    />
                    <button
                      type="button"
              ...
              <div className="flex items-start space-x-2.5 pt-2">
                ...
                />
                <label htmlFor="agree_terms" className="text-[11px] text-slate-600 cursor-pointer select-none">
                  Saya menyatakan bahwa seluruh data diri dan dokumen yang diunggah adalah benar dan sesuai dengan identitas resmi pegawai RSUD Bukit Kerman untuk keperluan verifikasi hak akses sistem.
                </label>
              </div>
