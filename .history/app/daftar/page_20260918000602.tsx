...
export default function DaftarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Pengecekan jika email sudah ada di Auth
      if (authData.user.identities && authData.user.identities.length === 0) {
        throw new Error('Email ini sudah terdaftar di Supabase Auth. Silakan hapus akun dari Dashboard Supabase Auth atau gunakan email lain.');
      }
