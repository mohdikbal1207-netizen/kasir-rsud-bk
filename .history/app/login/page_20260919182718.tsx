...
function LoginFormContent() {
  ...
  // Handler Login Fleksibel (Bisa Email Bebas Apa Saja)
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Ambil murni email yang diketik pengguna (tanpa manipulasi domain)
      ...
      setLoadingStepText('Mancatat Sesi Aktif...');
      try {
