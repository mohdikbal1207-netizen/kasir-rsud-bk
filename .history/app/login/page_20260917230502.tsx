...
function LoginFormContent() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'} flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden transition-colors duration-300`}>
      ...
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-emerald-200/30 rounded-full blur-[140px] pointer-events-none -z-10 animate-pulse"></div>
      <div className="absolute bottom-10 right-10 w-[500px] h-[500px] bg-teal-200/20 rounded-full blur-[120px] pointer-events-none -z-10"></div>
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex-1 flex items-center justify-center relative z-10">
        
        {/* Layout Grid Dua Kolom untuk Menghilangkan Ruang Kosong Berlebih */}
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          
          {/* Kolom Kiri: Panel Estetika Informasi Rumah Sakit & Branding */}
          <div className="hidden lg:flex lg:col-span-6 flex-col justify-center space-y-6 pr-4">
            
            <div className="inline-flex items-center space-x-2.5 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-2xl text-emerald-600 w-fit backdrop-blur-md">
            ...
            <div className="space-y-3">
              <h1 className="text-3xl xl:text-4xl font-black tracking-tight leading-tight">
                ...
                <span className="text-emerald-600 dark:text-emerald-400">Layanan Kesehatan Bermutu</span>
              </h1>
              <p className={`text-sm leading-relaxed max-w-lg ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
            ...
            {/* Kartu Highlight / Fitur Unggulan Estetik */}
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className={`p-4 rounded-2xl border transition ${isDarkMode ? 'bg-slate-900/60 border-slate-800' : 'bg-white/70 border-slate-200/80 shadow-sm'} backdrop-blur-md flex items-start space-x-3`}>
                <div className="p-2.5 bg-emerald-500/10 rounded-xl text-emerald-600">
                  <Award className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-xs font-bold">Terakreditasi Utama</h3>
                  <p className={`text-[11px] mt-0.5 ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Standar mutu LARS-DHP</p>
                </div>
              </div>
              ...
              <div className={`p-4 rounded-2xl border transition ${isDarkMode ? 'bg-slate-900/60 border-slate-800' : 'bg-white/70 border-slate-200/80 shadow-sm'} backdrop-blur-md flex items-start space-x-3`}>
                ...
                <div>
                  <h3 className="text-xs font-bold">Real-time Sesi Staf</h3>
                  <p className={`text-[11px] mt-0.5 ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Keamanan &amp; Audit Trail</p>
                </div>
              </div>
            </div>

            <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-slate-900/40 border-slate-800 text-slate-400' : 'bg-slate-100/80 border-slate-200 text-slate-500'} text-xs flex items-center space-x-2`}>
          ...
          {/* Kolom Kanan: Kartu Form Login Estetik */}
