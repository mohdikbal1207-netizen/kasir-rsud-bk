  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'} flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden transition-colors duration-300`}>
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex-1 flex items-center justify-center relative z-10">
        ...
        {/* Layout Grid Dua Kolom dengan Perbedaan Warna Kontras yang Estetik */}
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          
          {/* Kolom Kiri: Panel Informasi & Branding dengan Warna Gradasi Khusus yang Berbeda */}
          <div className="hidden lg:flex lg:col-span-6 flex-col justify-center space-y-6 p-8 rounded-3xl bg-gradient-to-br from-emerald-900 via-teal-900 to-slate-900 text-white shadow-2xl relative overflow-hidden">
            
            {/* Dekorasi Cahaya Halus di dalam Panel Kiri */}
            <div className="absolute -top-24 -right-24 w-72 h-72 bg-emerald-500/20 rounded-full blur-3xl pointer-events-none"></div>

            <div className="inline-flex items-center space-x-2.5 bg-white/10 border border-white/20 px-4 py-2 rounded-2xl text-emerald-300 w-fit backdrop-blur-md">
            ...
            {/* Kartu Highlight / Fitur Unggulan */}
            ...
            <div className="p-4 rounded-2xl border bg-white/5 border-white/10 text-slate-300 text-xs flex items-center space-x-2">
          ...
          {/* Kolom Kanan: Kartu Form Login Berwarna Bersih & Kontras */}
          <div className="w-full lg:col-span-6 flex justify-center">
            <div className="w-full max-w-md space-y-4">
              ...
              <div className={`${isDarkMode ? 'bg-slate-900/95 border-slate-800 text-slate-100 shadow-slate-950/80' : 'bg-white border-slate-200/90 text-slate-800 shadow-xl'} border rounded-3xl p-6 sm:p-8 backdrop-blur-xl relative overflow-hidden transition-transform ${shakeCard ? 'animate-bounce' : ''}`}>
                
                {/* Header Kontrol Kanan Atas: Shift Aktif & Tombol Dark Mode yang Diperbaiki (Tanpa Tumpuk) */}
