...
export default function LoginPage() {
  ...
  // Deteksi Status Koneksi Internet & Memuat Remember Me
  useEffect(() => {
  ...
  const triggerError = (msg: string) => {
    setErrorMessage(msg);
    setShakeCard(true);
    setTimeout(() => setShakeCard(false), 500); // Reset animasi shake
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden">
      ...
      <main className="w-full max-w-6xl mx-auto px-3 sm:px-4 py-6 sm:py-10 flex-1 flex items-center justify-center relative z-10">
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <div className={`bg-white/95 border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-slate-200/60 backdrop-blur-xl relative overflow-hidden transition-transform ${shakeCard ? 'animate-bounce' : ''}`}>
            ...
            {/* Error Banner */}
            {errorMessage && (
              <div className="mb-4 p-3.5 bg-rose-50 border border-rose-200 rounded-2xl text-xs text-rose-700 flex items-start space-x-2.5 animate-in fade-in duration-200 shadow-sm">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-10 pr-3.5 py-3 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition font-medium"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-10 pr-10 py-3 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition font-medium"
                  />
                  <button
                    type="button"
                ...
                {isCapsLockOn && (
                  <p className="text-[10px] text-amber-600 font-medium flex items-center gap-1 mt-1 pl-1">
            ...
            <div className="mt-6 pt-5 border-t border-slate-100 text-center space-y-3">
              ...
              <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-2xl p-3 flex items-center justify-between shadow-inner">
                <div className="text-left">
                  <p className="text-[11px] font-bold text-slate-800">Staf Baru / Belum Punya Akun?</p>
                  <p className="text-[10px] text-slate-500">Ajukan hak akses sistem rumah sakit.</p>
                </div>
                <Link
                  href="/daftar"
