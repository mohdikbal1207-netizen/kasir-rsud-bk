              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs leading-relaxed">
                <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-5 space-y-3">
                  ...
                  <p className="text-slate-300">
                    Total pendapatan RS saat ini mencapai <strong className="text-white">{formatRupiah(summary.grand_total_pendapatan_rs)}</strong>. Kontribusi terbesar didorong oleh layanan Rawat Inap, Rawat Jalan, dan farmasi obat. Perlu dioptimalkan penagihan klaim asuransi untuk menjaga cash flow BLUD.
                  </p>
                </div>
