...
export default function ManajemenLayout({ children }: { children: React.ReactNode }) {
  ...
  // Fitur Baru: Status Koneksi & Inaktivitas
  ...
  // Fitur Baru: Identitas User & Lock Screen State
  ...
  // Fitur Baru: Durasi Sesi & Latency Database Supabase
  ...
  // Verifikasi Hak Akses Portal Manajemen (Logika Utama Asli Dijaga Presisi)
  useEffect(() => {
