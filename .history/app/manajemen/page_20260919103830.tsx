...
import { 
  ...
  ArrowUpDown,
  Filter // TAMBAHAN: Ikon untuk teks konteks
} from 'lucide-react';
import { 
  ResponsiveContainer, 
  BarChart, 
...
// TAMBAHAN: Helper untuk warna lencana triase IGD yang dinamis
const getTriaseColor = (triase: string) => {
  ...
  return 'bg-indigo-50 text-indigo-700 border-indigo-200'; // Default fallback
};
...
export default function ExecutiveManagementDashboard() {
  ...
  // Fungsi handler untuk Sorting Tabel
  ...
  // TAMBAHAN: Helper untuk warna panah sorting
  ...
  // TAMBAHAN: Helper untuk label filter dinamis
        ...
        {activeTab === 'rajal' && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="bg-white border border-slate-200 rounded-3xl print:rounded-xl p-6 shadow-sm space-y-4">
              ...
              <div className="overflow-x-auto max-h-[400px] print:max-h-none overflow-y-auto rounded-xl border border-slate-200 custom-scrollbar">
                    ...
                    {filteredIgd.length > 0 ? (
                      filteredIgd.map((item, idx) => (
                        <tr key={idx} className="hover:bg-slate-50 transition-colors print:break-inside-avoid">
                          ...
                          {/* Penerapan Helper Triase Dinamis */}
                          <td className="p-3">
