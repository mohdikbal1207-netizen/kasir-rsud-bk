...
import { Wrench, ShieldAlert, RefreshCcw, Building2, PhoneCall, LogIn, Activity } from 'lucide-react';
...
export default function MaintenancePublicPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-between p-6 select-none relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-[400px] h-[400px] bg-emerald-500/50 rounded-full blur-[160px] pointer-events-none"></div>
      ...
      <div className="flex items-center justify-between max-w-4xl mx-auto w-full pt-4 relative z-10">
        ...
        <div className="flex items-center gap-2">
          {/* FITUR BARU: Indikator Sinyal Realtime */}
      ...
      <main className="max-w-lg mx-auto w-full text-center space-y-6 my-auto py-12 relative z-10">
        ...
        {estimatedFinish && (
          <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-2xl inline-block shadow-inner backdrop-blur-sm">
            <span className="text-[10px] uppercase font-bold text-slate-500 block mb-0.5">Estimasi Layanan Normal Kembali:</span>
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          {/* FITUR BARU: Tombol Pintasan Coba Login */}
          <a
            href="/login"
      ...
      <div className="max-w-4xl mx-auto w-full text-center border-t border-slate-900 pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 gap-2 relative z-10">
        <span>Kendala mendesak atau butuh akses darurat? Hubungi IT Coordinator</span>
        <a href="https://wa.me/6282281155614" target="_blank" rel="noreferrer" className="text-emerald-400 font-bold hover:underline inline-flex items-center gap-1">
          <PhoneCall className="w-3 h-3" /> WhatsApp IT Support RSUD
        </a>
      </div>
    </div>
  );
