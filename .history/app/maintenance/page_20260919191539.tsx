...
import { Wrench, ShieldAlert, RefreshCcw, Building2, PhoneCall } from 'lucide-react';
...
export default function MaintenancePublicPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-between p-6 select-none relative overflow-hidden">
      ...
      {/* Efek Cahaya Estetik Background */}
      ...
      <main className="max-w-lg mx-auto w-full text-center space-y-6 my-auto py-12 relative z-10">
        <div className="w-20 h-20 bg-amber-500/10 border border-amber-500/20 text-amber-400 rounded-3xl flex items-center justify-center mx-auto shadow-2xl relative">
        ...
        {estimatedFinish && (
          <div className="bg-slate-900 border border-slate-800 p-4 rounded-2xl inline-block shadow-inner">
